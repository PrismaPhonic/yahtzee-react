  ...
  render() {
    ...
    return (
      <div className="Scoring">
        <h1>TOTAL SCORE: {this.props.upperScore + this.props.lowerScore}</h1>
        <section className="Scoring-section">
          <h2>Upper</h2>
          <h5>Score: {this.props.upperScore}</h5>
          <table cellSpacing="0">
            <tbody>
        ...
        <section className="Scoring-section Scoring-section-lower">
          <h2>Lower</h2>
          <h5>Score: {this.props.lowerScore}</h5>
          <table cellSpacing="0">
            <tbody>
        ...
        <PlayerScores playerScores={this.props.playerScores} />
      </div>
    )
  }
}
